...
@section('title', 'Import Suppliers - Excel')

@section('content')
@include('layouts.admin.include.message')

<div class="card">
    <form action="{{ route('suppliers.importProcess') }}" method="POST"
        class="form-horizontal needs-validation" enctype="multipart/form-data">
        @csrf
        <h5 class="card-header">Import Suppliers - Excel</h5>
        <div class="card-body">
            <div class="form-body">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="offset-sm-3 col-md-5">
                                ...
                                <a href="{{ asset('excel_templates/template_import_data_suppliers.xlsx') }}"
