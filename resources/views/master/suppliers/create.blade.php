...
<div class="card">
    <form action="{{ route('suppliers.store') }}" method="POST"
        ...
        @csrf
        <h5 class="card-header">Create Suppliers</h5>
        <div class="card-body">
            <div class="form-body">
                ...
                <div class="form-group row @error('bank_info') has-error @enderror">
                    ...
                    <div class="col-md-5">
                        <textarea name="bank_info" id="bank_info" class="form-control @error('bank_info') is-invalid @enderror">{{ old('bank_info') }}</textarea>
