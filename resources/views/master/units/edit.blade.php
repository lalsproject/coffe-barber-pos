        ...
        <div class="card-body">
            <div class="form-body">
                ...
                <div class="form-group row @error('description') has-error @enderror">
                    ...
                    <div class="col-md-5">
                        <textarea name="description" id="unitDescription" class="form-control @error('description') is-invalid @enderror">{{ old('description', $unit->description) }}</textarea>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="offset-sm-3 col-md-5">
                                ...
                                <a href="{{ route('brands.index') }}" class="btn btn-info btn-rounded"
