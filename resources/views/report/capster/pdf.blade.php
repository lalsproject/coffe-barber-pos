...
<body>
    <div class="text-center mb-4">
        ...
        <h5 class="text-muted">{{ $transaction->branch->branch }}</h5>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            <p class="text-start"><strong>Capster:</strong> {{ $transaction->capster->name }}</p>
        </div> --}}
        ...
        <p class="margin-custom"><strong>Capster:</strong> {{ $transaction->capster->name }}</p>
    </div>
    ...
    @foreach ($transaction_details as $item)
        ...
        <div class="row">
            <div class="col-md-6">
                <p style="margin-left:2px;">{{ $item->service->price }} x {{ $item->quantity }}</p>
            </div>
